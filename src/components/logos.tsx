...
export const getContainerLogo = (imageName: string): React.FC<React.SVGProps<SVGSVGElement>> => {
  ...
  if (lowerCaseImageName.includes('nginx')) return NginxLogo;
  if (lowerCaseImageName.includes('python')) return PythonLogo;
  if (lowerCaseImageName.includes('node')) return NodejsLogo;
  if (lowerCaseImageName.includes('postgres')) return PostgresLogo;
  if (lowerCaseImageName.includes('redis')) return RedisLogo;
